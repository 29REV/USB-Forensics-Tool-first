...
from core.analysis import detect_suspicious, enrich_summary
...
def write_xlsx(summaries: List[Dict], path: str) -> str:
    ...
    try:
        ...
        # headers
        headers = ['Device Name', 'Device ID', 'Vendor ID (VID)', 'Product ID (PID)', 'Serial Number', 'Drive Letter', 'First Seen (UTC)', 'Last Seen (UTC)', 'Total Connections', 'Communication Summary', 'Suspicious']
        ws.append(headers)
